...
const checkBillingOptions = async (app: string, billingOptions: BillingOptions, force: boolean) => {
  ...
  if (isFreeApp(billingOptions)) {
    ...
    if (selectedPlan.currency !== BRAZILIAN_REAL_CURRENCY_CODE) {
      /* Selecionou USD: tentar instalar e tratar de error de sem contrato, ou verificar contrato antes */
  ...
  await installApp(app, true, force, planId) // TODO: planId eé o planId do plano em BRL
